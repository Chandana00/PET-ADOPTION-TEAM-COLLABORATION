...
public class CustomerController {
	...
	public String applyFilters(Model model, HttpSession session, @RequestParam("type") String type,
		...
		Customer customer = customerService.findUser(messages.get(0));
        model.addAttribute("sessionMessages", messages);
        List<Pet> pets = customerService.filterPets(type,breed);
        model.addAttribute("pets", pets);
		return "customer/welcomecustomer";
	}
	...
	public String donatemoney(Model model, HttpSession session) {
		...
		model.addAttribute("donationmoney", donationmoney);
		return "customer/donatemoney";
	}
	...
	public String donatefood(Model model, HttpSession session) {
		...
		model.addAttribute("donationfood", donationfood);
		return "customer/donatefood";
	}
	

	@PostMapping("/donateFood")
	public String donateFood(@ModelAttribute("donationfood") DonationFood donationfood, Model model, HttpSession session) {
        ...
        donationfood.setUserMail(customer.getEmail());
        
        customerService.saveDonationFood(donationfood);
        return "redirect:/customer";
        
	}
	
	@GetMapping("/adopt")
	public String adopt(Model model, HttpSession session) {
	...
	@PostMapping("/adoptNow")
	public String adoptNow(@ModelAttribute("adopt") Adopt adopt, Model model, HttpSession session) {
        ...
        adopt.setUserMail(customer.getEmail());
